package com.example.hrApplication.controllers.v1.auth;
...
import com.example.hrApplication.payloads.request.LoginRequest;
import com.example.hrApplication.payloads.response.JwtResponse;
...
// import com.example.hrApplication.security.services.;
...
public class AuthController {
	...
	public ResponseEntity<?> authenticateUser(@Valid @RequestBody LoginRequest loginRequest) {
		...
		return ResponseEntity.ok(new JwtResponse(jwt,
			 ...
			 return ResponseEntity.status(HttpStatus.BAD_REQUEST).body(new MessageResponse("Wrong username or password!"));
